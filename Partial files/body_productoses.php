<?php
    if($val != ""){
        $val = trim($val, "'.");
        $product_shuffle = $product->especifica("categoria", $val);
        ?>
        <style>
            #filtro{
                display: none;
...
<section id="top">
        ...
        <div class="container">
            <div class="filters">
                <div id="filtro">
                    <h4 class="text-right">Categorías</h4>
            ...
            <h2 class="font-monse"><?php if($val != ""){ echo ucfirst($val); } else{ echo "Productos"; }?></h2>
